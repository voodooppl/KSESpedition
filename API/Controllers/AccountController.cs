...
public class AccountController(DataContext dataContext, ITokenService tokenService, IHttpContextAccessor httpContextAccessor) : BaseApiController(httpContextAccessor)
{
    [HttpPost("register")]
